  ...
  return (
    <div className="w-screen">
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            ...
            <button className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-60' disabled={loading || uploading} >{loading ? "Loading..." : "Create Listing"}</button>
